...
module Ivory.BSP.STM32F412.SYSCFG where
...
|]
syscfg_reg_i2c_bufout :: BitDataReg SYSCFG_I2C_BUFOUT
syscfg_reg_i2c_bufout = mkBitDataRegNamed (syscfg_periph_base + 0x2c) "i2c_bufout"
