...
module Ivory.BSP.STM32F723.RCC where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F723.MemoryMap (rcc_periph_base)
...
[ivory|
 bitdata RCC_APB1LPENR :: Bits 32 = rcc_apb1lpenr
  ...
  , rcc_apb1lpenr_rtcapblpen  :: Bit      -- RTCAPB clock enable during Sleep mode
