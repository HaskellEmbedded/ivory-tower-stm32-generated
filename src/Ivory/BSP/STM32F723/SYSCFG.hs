module Ivory.BSP.STM32F723.SYSCFG
  ( module Ivory.BSP.STM32F723.SYSCFG.Peripheral
  , module Ivory.BSP.STM32F723.SYSCFG.Regs
  , syscfg
  ) where
...
import Ivory.BSP.STM32F723.SYSCFG.Peripheral
import Ivory.BSP.STM32F723.SYSCFG.Regs
