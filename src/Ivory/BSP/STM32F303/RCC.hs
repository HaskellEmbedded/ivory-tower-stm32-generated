...
[ivory|
 bitdata RCC_APB1ENR :: Bits 32 = rcc_apb1enr
  ...
  , rcc_apb1enr_usart5en  :: Bit      -- USART 5 clock enable
  , rcc_apb1enr_usart4en  :: Bit      -- USART 4 clock enable
