...
data Interrupt
  ...
  | COMP123 -- 64 COMP1 & COMP2 & COMP3 interrupts combined with EXTI Lines 21, 22 and 29 interrupts
  | COMP456 -- 65 COMP4 & COMP5 & COMP6 interrupts combined with EXTI Lines 30, 31 and 32 interrupts
  ...
  | TIM20_UP -- 78 TIM20 Upgrade interrupt
