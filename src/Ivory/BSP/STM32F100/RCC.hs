...
module Ivory.BSP.STM32F100.RCC where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F100.MemoryMap (rcc_periph_base)
...
[ivory|
 bitdata RCC_APB1RSTR :: Bits 32 = rcc_apb1rstr
  { _                     :: Bit      -- (Reserved)
  , rcc_apb1rstr_cecrst     :: Bit      -- CEC reset
...
[ivory|
 bitdata RCC_APB1ENR :: Bits 32 = rcc_apb1enr
  { _                   :: Bit      -- (Reserved)
  , rcc_apb1enr_cecen     :: Bit      -- CEC clock enable
