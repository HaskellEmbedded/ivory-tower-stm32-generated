module Ivory.BSP.STM32F042.SYSCFG
  ( module Ivory.BSP.STM32F042.SYSCFG.Peripheral
  , module Ivory.BSP.STM32F042.SYSCFG.Regs
  , syscfg
  ) where
...
import Ivory.BSP.STM32F042.SYSCFG.Peripheral
import Ivory.BSP.STM32F042.SYSCFG.Regs
