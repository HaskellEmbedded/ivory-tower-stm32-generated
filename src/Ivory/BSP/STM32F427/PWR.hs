...
module Ivory.BSP.STM32F427.PWR where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F427.MemoryMap (pwr_periph_base)
...
[ivory|
 bitdata PWR_CR :: Bits 32 = pwr_cr
  ...
  , pwr_cr_adcdc1  :: Bit      -- Main regulator low voltage in deepsleep mode
  , _            :: Bit      -- (Reserved)
