...
import Ivory.HW
import Ivory.BSP.STM32F427.MemoryMap (rcc_periph_base)
...
[ivory|
 bitdata RCC_AHB3RSTR :: Bits 32 = rcc_ahb3rstr
  { _                  :: Bits 31  -- (Reserved)
  , rcc_ahb3rstr_fmcrst  :: Bit      -- Flexible static memory controller module reset
  }
|]
...
[ivory|
 bitdata RCC_AHB3ENR :: Bits 32 = rcc_ahb3enr
  { _                :: Bits 31  -- (Reserved)
  , rcc_ahb3enr_fmcen  :: Bit      -- Flexible static memory controller module clock enable
  }
|]
...
[ivory|
 bitdata RCC_AHB3LPENR :: Bits 32 = rcc_ahb3lpenr
  { _                    :: Bits 31  -- (Reserved)
  , rcc_ahb3lpenr_fmclpen  :: Bit      -- Flexible static memory controller module clock enable during Sleep mode
  }
|]
...
[ivory|
 bitdata RCC_DCKCFGR :: Bits 32 = rcc_dckcfgr
  ...
  , _                     :: Bits 2   -- (Reserved)
  , rcc_dckcfgr_pllsaidivr  :: Bits 2   -- division factor for LCD_CLK
  , _                     :: Bits 3   -- (Reserved)
  , rcc_dckcfgr_pllsaidivq  :: Bits 5   -- PLLSAI division factor for SAI1 clock
  , _                     :: Bits 3   -- (Reserved)
  , rcc_dckcfgr_plli2sdivq  :: Bits 5   -- PLLI2S division factor for SAI1 clock
  }
|]
