...
module Ivory.BSP.STM32F410.SYSCFG where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F410.MemoryMap (syscfg_periph_base)
...
[ivory|
 bitdata SYSCFG_CFGR :: Bits 32 = syscfg_cfgr
  { _                      :: Bits 30  -- (Reserved)
  , syscfg_cfgr_fmpi2c1_sda  :: Bit      -- FMPI2C1_SDA
  , syscfg_cfgr_fmpi2c1_scl  :: Bit      -- FMPI2C1_SCL
  }
|]
syscfg_reg_cfgr :: BitDataReg SYSCFG_CFGR
syscfg_reg_cfgr = mkBitDataRegNamed (syscfg_periph_base + 0x2c) "cfgr"
