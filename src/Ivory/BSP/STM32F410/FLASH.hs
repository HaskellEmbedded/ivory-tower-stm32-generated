...
module Ivory.BSP.STM32F410.FLASH where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F410.MemoryMap (flash_periph_base)
...
[ivory|
 bitdata FLASH_OPTCR :: Bits 32 = flash_optcr
  { flash_optcr_sprmod      :: Bit      -- SPRMOD
  , _                     :: Bits 10  -- (Reserved)
  , flash_optcr_nwrp        :: Bits 5   -- Not write protect
