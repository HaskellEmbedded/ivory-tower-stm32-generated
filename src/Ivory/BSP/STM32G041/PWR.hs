...
module Ivory.BSP.STM32G041.PWR where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32G041.MemoryMap (pwr_periph_base)
...
[ivory|
 bitdata PWR_CR2 :: Bits 32 = pwr_cr2
  { _               :: Bits 21  -- (Reserved)
  , pwr_cr2_usv       :: Bit      -- USV
  , pwr_cr2_iosv      :: Bit      -- IOSV
  , pwr_cr2_pvmenusb  :: Bit      -- PVMENUSB
  , pwr_cr2_pvmendac  :: Bit      -- PVMENDAC
...
[ivory|
 bitdata PWR_CR3 :: Bits 32 = pwr_cr3
  ...
  , pwr_cr3_enb_ulp  :: Bit      -- Ultra-low-power enable
...
[ivory|
 bitdata PWR_SR2 :: Bits 32 = pwr_sr2
  { _                :: Bits 16  -- (Reserved)
  , pwr_sr2_pvmodac    :: Bit      -- VDDA monitoring output flag
  , _                :: Bits 2   -- (Reserved)
  , pwr_sr2_pvmousb    :: Bit      -- USB supply voltage monitoring output flag
