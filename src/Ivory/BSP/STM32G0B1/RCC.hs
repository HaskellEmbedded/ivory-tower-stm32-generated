...
module Ivory.BSP.STM32G0B1.RCC where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32G0B1.MemoryMap (rcc_periph_base)
...
[ivory|
 bitdata RCC_PLLCFGR :: Bits 32 = rcc_pllcfgr
  ...
  , _                  :: Bits 2 -- (Reserved)
  , rcc_pllcfgr_pllsrc :: Bits 2 -- PLL input clock source
  }
|]
...
[ivory|
 bitdata RCC_CCIPR2 :: Bits 32 = rcc_ccipr2
  { _                   :: Bits 18 -- (Reserved)
  , rcc_ccipr2_usbsel   :: Bits 2  -- USBSEL
  , _                   :: Bits 2  -- (Reserved)
