module Ivory.BSP.STM32G0B1.GTIM
  ( GTIM(..)
  , GTIM32
  , GTIM16
  , tim2
...
tim4 =
  mkGTIM
    ...
    "tim4"
  where
  rccenable  = modifyReg rcc_reg_apbenr1 $ setBit   rcc_apbenr1_tim4en
  rccdisable = modifyReg rcc_reg_apbenr1 $ clearBit rcc_apbenr1_tim4en
