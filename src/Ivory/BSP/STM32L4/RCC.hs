...
module Ivory.BSP.STM32L4.RCC where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32L4.MemoryMap (rcc_periph_base)
...
[ivory|
 bitdata RCC_CR :: Bits 32 = rcc_cr
  ...
  , rcc_cr_msirange    :: RCC_MSIRANGE_L4  -- MSI clock ranges
...
[ivory|
 bitdata RCC_CFGR :: Bits 32 = rcc_cfgr
  ...
  , rcc_cfgr_sws       :: RCC_SYSCLK_L4  -- System clock switch status
  , rcc_cfgr_sw        :: RCC_SYSCLK_L4  -- System clock switch
  }
|]
...
[ivory|
 bitdata RCC_PLLCFGR :: Bits 32 = rcc_pllcfgr
  ...
  , rcc_pllcfgr_pllr     :: RCC_PLLQR_L4  -- Main PLL division factor for PLLCLK (system clock)
  , rcc_pllcfgr_pllren   :: Bit      -- Main PLL PLLCLK output enable
  , _                  :: Bit      -- (Reserved)
  , rcc_pllcfgr_pllq     :: RCC_PLLQR_L4  -- Main PLL division factor for PLLUSB1CLK(48 MHz clock)
  ...
  , _                  :: Bits 2   -- (Reserved)
  , rcc_pllcfgr_pllsrc   :: RCC_PLLSRC_L4  -- Main PLL, PLLSAI1 and PLLSAI2 entry clock source
  }
|]
...
[ivory|
 bitdata RCC_AHB2RSTR :: Bits 32 = rcc_ahb2rstr
  ...
  , rcc_ahb2rstr_hash1rst  :: Bit      -- Hash reset
...
[ivory|
 bitdata RCC_APB1RSTR1 :: Bits 32 = rcc_apb1rstr1
  ...
  , _                      :: Bit      -- (Reserved)
  , rcc_apb1rstr1_can2rst    :: Bit      -- CAN2 reset
...
[ivory|
 bitdata RCC_APB2RSTR :: Bits 32 = rcc_apb2rstr
  { _                     :: Bits 7   -- (Reserved)
  , rcc_apb2rstr_dfsdmrst   :: Bit      -- Digital filters for sigma-delata modulators (DFSDM) reset
  , _                     :: Bit      -- (Reserved)
...
[ivory|
 bitdata RCC_AHB2ENR :: Bits 32 = rcc_ahb2enr
  ...
  , rcc_ahb2enr_hash1en  :: Bit      -- HASH clock enable
...
[ivory|
 bitdata RCC_APB1ENR1 :: Bits 32 = rcc_apb1enr1
  ...
  , _                    :: Bit      -- (Reserved)
  , rcc_apb1enr1_can2en    :: Bit      -- CAN2 clock enable
...
[ivory|
 bitdata RCC_APB2ENR :: Bits 32 = rcc_apb2enr
  { _                     :: Bits 7   -- (Reserved)
  , rcc_apb2enr_dfsdmen     :: Bit      -- DFSDM timer clock enable
  , _                     :: Bit      -- (Reserved)
...
[ivory|
 bitdata RCC_AHB2SMENR :: Bits 32 = rcc_ahb2smenr
  ...
  , rcc_ahb2smenr_hash1smen  :: Bit      -- HASH clock enable during Sleep and Stop modes
...
[ivory|
 bitdata RCC_APB1SMENR1 :: Bits 32 = rcc_apb1smenr1
  ...
  , _                        :: Bit      -- (Reserved)
  , rcc_apb1smenr1_can2smen    :: Bit      -- CAN2 clocks enable during Sleep and Stop modes
...
[ivory|
 bitdata RCC_APB2SMENR :: Bits 32 = rcc_apb2smenr
  { _                       :: Bits 7   -- (Reserved)
  , rcc_apb2smenr_dfsdmsmen   :: Bit      -- DFSDM timer clocks enable during Sleep and Stop modes
  , _                       :: Bit      -- (Reserved)
...
[ivory|
 bitdata RCC_CCIPR :: Bits 32 = rcc_ccipr
  { rcc_ccipr_dfsdmsel    :: Bit      -- DFSDM clock source selection
