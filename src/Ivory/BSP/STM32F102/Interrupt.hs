module Ivory.BSP.STM32F102.Interrupt where
...
data Interrupt
  ...
  | I2C1_EV -- 31 I2C event interrupt
  | I2C1_ER -- 32 I2C errot interrupt
  | I2C2_EV -- 33 I2C event interrupt
  | I2C2_ER -- 34 I2C errot interrupt
