...
mkUARTVersion
       ...
       -> String
       -> UART
mkUARTVersion V1 i e1 e2 j c s = WrappedV1 $ P1.mkUART i e1 e2 j c s
mkUARTVersion V2 i e1 e2 j c s = WrappedV2 $ P2.mkUART i e1 e2 j c s
mkUARTVersion V3 i e1 e2 j c s = WrappedV3 $ P3.mkUART i e1 e2 j c s
