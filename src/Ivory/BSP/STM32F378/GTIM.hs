...
tim18 =
  mkGTIM
    ...
    "tim18"
  where
  rccenable  = modifyReg rcc_reg_apb1enr $ setBit   rcc_apb1enr_tim18en
  rccdisable = modifyReg rcc_reg_apb1enr $ clearBit rcc_apb1enr_tim18en
...
tim19 =
  mkGTIM
    ...
    "tim19"
  where
  rccenable  = modifyReg rcc_reg_apb2enr $ setBit   rcc_apb2enr_tim19en
  rccdisable = modifyReg rcc_reg_apb2enr $ clearBit rcc_apb2enr_tim19en
