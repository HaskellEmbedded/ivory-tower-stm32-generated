...
module Ivory.BSP.STM32F750.RCC where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F750.MemoryMap (rcc_periph_base)
...
[ivory|
 bitdata RCC_APB1RSTR :: Bits 32 = rcc_apb1rstr
  ...
  , rcc_apb1rstr_i2c4rst     :: Bit      -- I2C 4 reset
...
[ivory|
 bitdata RCC_APB1LPENR :: Bits 32 = rcc_apb1lpenr
  ...
  , rcc_apb1lpenr_ceclpen      :: Bit      -- HDMI-CEN clock enable during Sleep mode
