module Ivory.BSP.STM32F768.SYSCFG
  ( module Ivory.BSP.STM32F768.SYSCFG.Peripheral
  , module Ivory.BSP.STM32F768.SYSCFG.Regs
  , syscfg
  ) where
...
import Ivory.BSP.STM32F768.SYSCFG.Peripheral
import Ivory.BSP.STM32F768.SYSCFG.Regs
