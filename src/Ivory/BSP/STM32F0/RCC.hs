...
module Ivory.BSP.STM32F0.RCC where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F0.MemoryMap (rcc_periph_base)
...
[ivory|
 bitdata RCC_CFGR :: Bits 32 = rcc_cfgr
  ...
  , rcc_cfgr_pllsrc    :: RCC_PLLSRC_F0  -- PLL input clock source
  ...
  , rcc_cfgr_sws       :: RCC_SYSCLK_F0  -- System Clock Switch Status
  , rcc_cfgr_sw        :: RCC_SYSCLK_F0  -- System clock Switch
  }
|]
...
[ivory|
 bitdata RCC_APB2RSTR :: Bits 32 = rcc_apb2rstr
  ...
  , _                     :: Bit      -- (Reserved)
  , rcc_apb2rstr_usart8rst  :: Bit      -- USART8 reset
  , rcc_apb2rstr_usart7rst  :: Bit      -- USART7 reset
...
[ivory|
 bitdata RCC_APB2ENR :: Bits 32 = rcc_apb2enr
  ...
  , _                   :: Bit      -- (Reserved)
  , rcc_apb2enr_usart8en  :: Bit      -- USART8 clock enable
  , rcc_apb2enr_usart7en  :: Bit      -- USART7 clock enable
