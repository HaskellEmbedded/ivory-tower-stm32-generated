...
module Ivory.BSP.STM32F446.RCC where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F446.MemoryMap (rcc_periph_base)
...
[ivory|
 bitdata RCC_PLLCFGR :: Bits 32 = rcc_pllcfgr
  { _                 :: Bit      -- (Reserved)
  , rcc_pllcfgr_pllr    :: Bits 3   -- Main PLL division factor for I2Ss, SAIs, SYSTEM and SPDIF-Rx clocks
...
[ivory|
 bitdata RCC_AHB2RSTR :: Bits 32 = rcc_ahb2rstr
  ...
  , _                    :: Bits 6   -- (Reserved)
  , rcc_ahb2rstr_dcmirst   :: Bit      -- Camera interface reset
  }
|]
...
[ivory|
 bitdata RCC_APB1RSTR :: Bits 32 = rcc_apb1rstr
  ...
  , rcc_apb1rstr_spdifrst    :: Bit      -- SPDIF-IN reset
...
[ivory|
 bitdata RCC_APB1ENR :: Bits 32 = rcc_apb1enr
  ...
  , rcc_apb1enr_cecen      :: Bit      -- CEC interface clock enable
  , rcc_apb1enr_can2en     :: Bit      -- CAN 2 clock enable
  ...
  , rcc_apb1enr_spdifen    :: Bit      -- SPDIF-IN clock enable
...
[ivory|
 bitdata RCC_APB1LPENR :: Bits 32 = rcc_apb1lpenr
  ...
  , rcc_apb1lpenr_ceclpen      :: Bit      -- CEC clock enable during Sleep mode
  ...
  , rcc_apb1lpenr_spdiflpen    :: Bit      -- SPDIF clock enable during Sleep mode
...
[ivory|
 bitdata RCC_APB2LPENR :: Bits 32 = rcc_apb2lpenr
  { _                       :: Bits 8   -- (Reserved)
  , rcc_apb2lpenr_sai2lpen    :: Bit      -- SAI2 clock enable
  , rcc_apb2lpenr_sai1lpen    :: Bit      -- SAI1 clock enable
  , _                       :: Bits 3   -- (Reserved)
...
[ivory|
 bitdata RCC_BDCR :: Bits 32 = rcc_bdcr
  ...
  , _              :: Bits 4   -- (Reserved)
  , rcc_bdcr_lsemod  :: Bit      -- External low-speed oscillator mode
...
[ivory|
 bitdata RCC_PLLI2SCFGR :: Bits 32 = rcc_plli2scfgr
  ...
  , _                     :: Bits 6   -- (Reserved)
  , rcc_plli2scfgr_plli2sp  :: Bits 2   -- PLLI2S division factor for SPDIF-IN clock
  , _                     :: Bit      -- (Reserved)
  , rcc_plli2scfgr_plli2sn  :: Bits 9   -- PLLI2S multiplication factor for VCO
  , rcc_plli2scfgr_plli2sm  :: Bits 6   -- Division factor for audio PLL (PLLI2S) input clock
  }
|]
...
[ivory|
 bitdata RCC_PLLSAICFGR :: Bits 32 = rcc_pllsaicfgr
  { _                     :: Bits 4   -- (Reserved)
  , rcc_pllsaicfgr_pllsaiq  :: Bits 4   -- PLLSAI division factor for SAIs clock
  , _                     :: Bits 6   -- (Reserved)
  , rcc_pllsaicfgr_pllsaip  :: Bits 2   -- PLLSAI division factor for 48 MHz clock
  , _                     :: Bit      -- (Reserved)
  , rcc_pllsaicfgr_pllsain  :: Bits 9   -- PLLSAI division factor for VCO
  , rcc_pllsaicfgr_pllsaim  :: Bits 6   -- Division factor for audio PLLSAI input clock
  }
|]
...
[ivory|
 bitdata RCC_DCKCFGR :: Bits 32 = rcc_dckcfgr
  { _                     :: Bits 3   -- (Reserved)
  , rcc_dckcfgr_i2s2src     :: Bits 2   -- I2S APB2 clock source selection
  , rcc_dckcfgr_i2s1src     :: Bits 2   -- I2S APB1 clock source selection
  , rcc_dckcfgr_timpre      :: Bit      -- Timers clocks prescalers selection
  , rcc_dckcfgr_sai2src     :: Bits 2   -- SAI2 clock source selection
  , rcc_dckcfgr_sai1src     :: Bits 2   -- SAI1 clock source selection
  , _                     :: Bits 7   -- (Reserved)
  , rcc_dckcfgr_pllsaidivq  :: Bits 5   -- PLLSAI division factor for SAIs clock
  , _                     :: Bits 3   -- (Reserved)
  , rcc_dckcfgr_plli2sdivq  :: Bits 5   -- PLLI2S division factor for SAIs clock
  }
|]
...
[ivory|
 bitdata RCC_DCKCFGR2 :: Bits 32 = rcc_dckcfgr2
  { _                      :: Bits 2   -- (Reserved)
  , rcc_dckcfgr2_spdifrxsel  :: Bit      -- SPDIF clock selection
  , rcc_dckcfgr2_sdiosel     :: Bit      -- SDIO clock selection
  , rcc_dckcfgr2_ck48msel    :: Bit      -- SDIO/USBFS/HS clock selection
  , rcc_dckcfgr2_cecsel      :: Bit      -- HDMI CEC clock source selection
  , _                      :: Bits 2   -- (Reserved)
  , rcc_dckcfgr2_fmpi2c1sel  :: Bits 2   -- I2C4 kernel clock source selection
  , _                      :: Bits 22  -- (Reserved)
  }
|]
