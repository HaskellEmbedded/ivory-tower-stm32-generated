...
module Ivory.BSP.STM32F446.FLASH where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F446.MemoryMap (flash_periph_base)
...
[ivory|
 bitdata FLASH_SR :: Bits 32 = flash_sr
  ...
  , _              :: Bits 7   -- (Reserved)
  , flash_sr_rderr   :: Bit      -- Read Protection Error
...
[ivory|
 bitdata FLASH_OPTCR :: Bits 32 = flash_optcr
  { flash_optcr_sprmod      :: Bit      -- Selection of Protection Mode of nWPRi bits
  , _                     :: Bits 7   -- (Reserved)
