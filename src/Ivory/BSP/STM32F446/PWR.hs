...
module Ivory.BSP.STM32F446.PWR where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F446.MemoryMap (pwr_periph_base)
...
[ivory|
 bitdata PWR_CR :: Bits 32 = pwr_cr
  { _            :: Bits 10  -- (Reserved)
  , pwr_cr_fissr   :: Bit      -- Flash Interface Stop while System Run
  , pwr_cr_fmssr   :: Bit      -- Flash Memory Stop while System Run
