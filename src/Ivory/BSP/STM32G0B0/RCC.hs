...
module Ivory.BSP.STM32G0B0.RCC where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32G0B0.MemoryMap (rcc_periph_base)
...
[ivory|
 bitdata RCC_PLLSYSCFGR :: Bits 32 = rcc_pllsyscfgr
  ...
  , rcc_pllsyscfgr_plln    :: Bits 8   -- PLL frequency multiplication factor N
  , _                    :: Bit      -- (Reserved)
