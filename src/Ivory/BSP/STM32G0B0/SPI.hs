module Ivory.BSP.STM32G0B0.SPI (
    spi1
  , spi2
  , spi3
  ) where
...
spi3 = mkSPI spi3_periph_base
          ...
          "spi3"
  where
  rccenable  = modifyReg rcc_reg_apbenr1 $ setBit   rcc_apbenr1_spi3en
  rccdisable = modifyReg rcc_reg_apbenr1 $ clearBit rcc_apbenr1_spi3en
