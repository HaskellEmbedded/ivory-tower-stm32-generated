...
module Ivory.BSP.STM32F030.SYSCFG where
...
syscfg_reg_cfgr1 = mkBitDataRegNamed (syscfg_periph_base + 0x0) "cfgr1"
...
syscfg_reg_cfgr2 = mkBitDataRegNamed (syscfg_periph_base + 0x18) "cfgr2"
