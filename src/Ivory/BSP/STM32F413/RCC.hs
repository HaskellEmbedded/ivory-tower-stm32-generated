...
module Ivory.BSP.STM32F413.RCC where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F413.MemoryMap (rcc_periph_base)
...
[ivory|
 bitdata RCC_PLLCFGR :: Bits 32 = rcc_pllcfgr
  { _                 :: Bit      -- (Reserved)
  , rcc_pllcfgr_pllr    :: Bits 3   -- Main PLL (PLL) division factor for I2S, DFSDM clocks
...
[ivory|
 bitdata RCC_AHB2RSTR :: Bits 32 = rcc_ahb2rstr
  ...
  , _                    :: Bit      -- (Reserved)
  , rcc_ahb2rstr_cryprst   :: Bit      -- CRYP module reset
  , _                    :: Bits 4   -- (Reserved)
  }
|]
...
[ivory|
 bitdata RCC_AHB3RSTR :: Bits 32 = rcc_ahb3rstr
  { _                   :: Bits 30  -- (Reserved)
  , rcc_ahb3rstr_qspirst  :: Bit      -- QUADSPI module reset
  , rcc_ahb3rstr_fsmcrst  :: Bit      -- Flexible memory controller module reset
  }
|]
...
[ivory|
 bitdata RCC_APB1RSTR :: Bits 32 = rcc_apb1rstr
  { rcc_apb1rstr_uart8rst     :: Bit      -- UART 8 reset
  , rcc_apb1rstr_uart7rst     :: Bit      -- UART 7 reset
  ...
  , rcc_apb1rstr_fmpi2c1rst   :: Bit      -- FMPI2C1 reset
  , rcc_apb1rstr_i2c3rst      :: Bit      -- I2C3 reset
  , rcc_apb1rstr_i2c2rst      :: Bit      -- I2C 2 reset
  , rcc_apb1rstr_i2c1rst      :: Bit      -- I2C 1 reset
  , rcc_apb1rstr_uart5rst     :: Bit      -- UART5 reset
  , rcc_apb1rstr_uart4rst     :: Bit      -- UART4 reset
  ...
  , _                       :: Bit      -- (Reserved)
  , rcc_apb1rstr_lptimer1rst  :: Bit      -- LPTimer1 reset
...
[ivory|
 bitdata RCC_APB2RSTR :: Bits 32 = rcc_apb2rstr
  { _                     :: Bits 6   -- (Reserved)
  , rcc_apb2rstr_dfsdm2rst  :: Bit      -- DFSDM2 reset
  , rcc_apb2rstr_dfsdmrst   :: Bit      -- DFSDMRST
  , _                     :: Bit      -- (Reserved)
  , rcc_apb2rstr_sai1rst    :: Bit      -- SAI1 reset
  , _                     :: Bit      -- (Reserved)
  , rcc_apb2rstr_spi5rst    :: Bit      -- SPI5RST
  , _                     :: Bit      -- (Reserved)
  ...
  , rcc_apb2rstr_uart10rst  :: Bit      -- UART10 reset
  , rcc_apb2rstr_uart9rst   :: Bit      -- UART9 reset
...
[ivory|
 bitdata RCC_AHB2ENR :: Bits 32 = rcc_ahb2enr
  ...
  , _                  :: Bit      -- (Reserved)
  , rcc_ahb2enr_crypen   :: Bit      -- CRYP clock enable
  , _                  :: Bits 4   -- (Reserved)
  }
|]
...
[ivory|
 bitdata RCC_AHB3ENR :: Bits 32 = rcc_ahb3enr
  { _                 :: Bits 30  -- (Reserved)
  , rcc_ahb3enr_qspien  :: Bit      -- QUADSPI memory controller module clock enable
  , rcc_ahb3enr_fsmcen  :: Bit      -- Flexible memory controller module clock enable
  }
|]
...
[ivory|
 bitdata RCC_APB1ENR :: Bits 32 = rcc_apb1enr
  ...
  , rcc_apb1enr_dacen       :: Bit      -- DAC clock enable
  , rcc_apb1enr_pwren       :: Bit      -- Power interface clock enable
  , rcc_apb1enr_can3en      :: Bit      -- CAN 3 clock enable
  , rcc_apb1enr_can2en      :: Bit      -- CAN2EN
  , rcc_apb1enr_can1en      :: Bit      -- CAN1EN
  , rcc_apb1enr_fmpi2c1en   :: Bit      -- FMPI2C1 clock enable
  ...
  , rcc_apb1enr_rtcapben    :: Bit      -- clock enable
  , rcc_apb1enr_lptimer1en  :: Bit      -- LPTimer 1 clock enable
...
[ivory|
 bitdata RCC_APB2ENR :: Bits 32 = rcc_apb2enr
  { _                   :: Bits 6   -- (Reserved)
  , rcc_apb2enr_dfsdm2en  :: Bit      -- DFSDM2 clock enable
  , rcc_apb2enr_dfsdmen   :: Bit      -- DFSDMEN
  , _                   :: Bit      -- (Reserved)
  , rcc_apb2enr_sai1en    :: Bit      -- SAI 1 clock enable
  , _                   :: Bit      -- (Reserved)
  ...
  , rcc_apb2enr_uart10en  :: Bit      -- UART10 clock enable
  , rcc_apb2enr_uart9en   :: Bit      -- UART9 clock enable
...
[ivory|
 bitdata RCC_AHB1LPENR :: Bits 32 = rcc_ahb1lpenr
  ...
  , _                      :: Bits 3   -- (Reserved)
  , rcc_ahb1lpenr_sram2lpen  :: Bit      -- SRAM2interface clock enable during Sleep mode
...
[ivory|
 bitdata RCC_AHB2LPENR :: Bits 32 = rcc_ahb2lpenr
  ...
  , _                      :: Bits 4   -- (Reserved)
  , rcc_ahb2lpenr_qspilpen   :: Bit      -- QUADSPI memory controller module clock enable during Sleep mode
  , rcc_ahb2lpenr_fsmclpen   :: Bit      -- Flexible memory controller module clock enable during Sleep mode
  }
|]
...
[ivory|
 bitdata RCC_AHB3LPENR :: Bits 32 = rcc_ahb3lpenr
  { _                     :: Bits 30  -- (Reserved)
  , rcc_ahb3lpenr_qspilpen  :: Bit      -- QUADSPI memory controller module clock enable during Sleep mode
  , rcc_ahb3lpenr_fsmclpen  :: Bit      -- Flexible memory controller module clock enable during Sleep mode
  }
|]
...
[ivory|
 bitdata RCC_APB1LPENR :: Bits 32 = rcc_apb1lpenr
  ...
  , rcc_apb1lpenr_daclpen       :: Bit      -- DAC clock enable during Sleep mode
  , rcc_apb1lpenr_pwrlpen       :: Bit      -- Power interface clock enable during Sleep mode
  , rcc_apb1lpenr_can3lpen      :: Bit      -- CAN3 clock enable during Sleep mode
  , rcc_apb1lpenr_can2lpen      :: Bit      -- CAN2LPEN
  , rcc_apb1lpenr_can1lpen      :: Bit      -- CAN1LPEN
  , rcc_apb1lpenr_fmpi2c1lpen   :: Bit      -- FMPI2C1 clock enable during Sleep
  ...
  , rcc_apb1lpenr_lptimer1lpen  :: Bit      -- TIM14 clock enable during Sleep mode
...
[ivory|
 bitdata RCC_APB2LPENR :: Bits 32 = rcc_apb2lpenr
  { _                       :: Bits 6   -- (Reserved)
  , rcc_apb2lpenr_dfsdm2lpen  :: Bit      -- DFSDM2 clock enable during Sleep mode
  , rcc_apb2lpenr_dfsdmlpen   :: Bit      -- DFSDMLPEN
  , _                       :: Bit      -- (Reserved)
  , rcc_apb2lpenr_sai1lpen    :: Bit      -- SAI1 clock enable during Sleep mode
  , _                       :: Bit      -- (Reserved)
  , rcc_apb2lpenr_spi5lpen    :: Bit      -- SPI5 clock enable during Sleep mode
  , _                       :: Bit      -- (Reserved)
  ...
  , rcc_apb2lpenr_extitlpen   :: Bit      -- EXTIT APB and SYSCTRL PFREE clock enable during Sleep mode
  ...
  , rcc_apb2lpenr_uart10lpen  :: Bit      -- UART10 clock enable during Sleep mode
  , rcc_apb2lpenr_uart9lpen   :: Bit      -- UART9 clock enable during Sleep mode
...
[ivory|
 bitdata RCC_BDCR :: Bits 32 = rcc_bdcr
  ...
  , _              :: Bits 4   -- (Reserved)
  , rcc_bdcr_lsemod  :: Bit      -- External low-speed oscillator bypass
...
[ivory|
 bitdata RCC_PLLI2SCFGR :: Bits 32 = rcc_plli2scfgr
  ...
  , rcc_plli2scfgr_plli2sq    :: Bits 4   -- PLLI2S division factor for USB OTG FS/SDIO/RNG clock
  , _                       :: Bit      -- (Reserved)
  , rcc_plli2scfgr_plli2ssrc  :: Bit      -- PLLI2S entry clock source
  , _                       :: Bits 7   -- (Reserved)
  , rcc_plli2scfgr_plli2sn    :: Bits 9   -- PLLI2S multiplication factor for VCO
  , rcc_plli2scfgr_plli2sm    :: Bits 6   -- Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
  }
|]
...
[ivory|
 bitdata RCC_DCKCFGR :: Bits 32 = rcc_dckcfgr
  { rcc_dckcfgr_ckdfsdm1sel   :: Bit      -- DFSDM1 Kernel clock selection
  , _                       :: Bits 2   -- (Reserved)
  , rcc_dckcfgr_i2s2src       :: Bits 2   -- I2S APB2 clocks source selection (I2S1/4/5)
  , rcc_dckcfgr_i2s1src       :: Bits 2   -- I2S APB1 clocks source selection (I2S2/3)
  , rcc_dckcfgr_timpre        :: Bit      -- Timers clocks prescalers selection
  , rcc_dckcfgr_sai1bsrc      :: Bits 2   -- SAI1-B clock source selection
  , rcc_dckcfgr_sai1asrc      :: Bits 2   -- SAI1-A clock source selection
  , _                       :: Bits 4   -- (Reserved)
  , rcc_dckcfgr_ckdfsdm1asel  :: Bit      -- DFSDM1 audio clock selection.
  , rcc_dckcfgr_ckdfsdm2asel  :: Bit      -- DFSDM2 audio clock selection
  , _                       :: Bit      -- (Reserved)
  , rcc_dckcfgr_plldivr       :: Bits 5   -- PLL division factor for SAI1 A/B clock
  , _                       :: Bits 3   -- (Reserved)
  , rcc_dckcfgr_plli2sdivr    :: Bits 5   -- PLLI2S division factor for SAI1 A/B clock
  }
|]
...
--  | address: 0x40023890
[ivory|
 bitdata RCC_CKGATENR :: Bits 32 = rcc_ckgatenr
  { _                         :: Bits 24  -- (Reserved)
  , rcc_ckgatenr_evtcl_cken     :: Bit      -- EVTCL_CKEN
  , rcc_ckgatenr_rcc_cken       :: Bit      -- RCC clock enable
  , rcc_ckgatenr_flitf_cken     :: Bit      -- Flash Interface clock enable
  , rcc_ckgatenr_sram_cken      :: Bit      -- SRQAM controller clock enable
  , rcc_ckgatenr_spare_cken     :: Bit      -- Spare clock enable
  , rcc_ckgatenr_cm4dbg_cken    :: Bit      -- Cortex M4 ETM clock enable
  , rcc_ckgatenr_ahb2apb2_cken  :: Bit      -- AHB to APB2 Bridge clock enable
  , rcc_ckgatenr_ahb2apb1_cken  :: Bit      -- AHB to APB1 Bridge clock enable
  }
|]
rcc_reg_ckgatenr :: BitDataReg RCC_CKGATENR
rcc_reg_ckgatenr = mkBitDataRegNamed (rcc_periph_base + 0x90) "ckgatenr"
...
[ivory|
 bitdata RCC_DCKCFGR2 :: Bits 32 = rcc_dckcfgr2
  { rcc_dckcfgr2_lptim1sel   :: Bits 2   -- LPTIM1 kernel clock source selection
  , _                      :: Bit      -- (Reserved)
  , rcc_dckcfgr2_sdiosel     :: Bit      -- SDIO clock selection.
  , rcc_dckcfgr2_ck48msel    :: Bit      -- SDIO/USBFS clock selection.
  , _                      :: Bits 3   -- (Reserved)
  , rcc_dckcfgr2_fmpi2c1sel  :: Bits 2   -- I2CFMP1 kernel clock source selection
  , _                      :: Bits 22  -- (Reserved)
  }
|]
