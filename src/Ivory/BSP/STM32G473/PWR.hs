...
module Ivory.BSP.STM32G473.PWR where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32G473.MemoryMap (pwr_periph_base)
...
[ivory|
 bitdata PWR_CR2 :: Bits 32 = pwr_cr2
  { _             :: Bits 24  -- (Reserved)
  , pwr_cr2_pvmen4  :: Bit      -- Peripheral voltage monitoring 4 enable: VDDA vs. OPAMP/DAC min voltage
  , pwr_cr2_pvmen3  :: Bit      -- Peripheral voltage monitoring 3 enable: VDDA vs. ADC min voltage 1.62V
  , pwr_cr2_pvmen2  :: Bit      -- Peripheral voltage monitoring 2 enable: VDDA vs. Fast DAC min voltage
  , pwr_cr2_pvmen1  :: Bit      -- Peripheral voltage monitoring 1 enable: VDDA vs. COMP min voltage
...
[ivory|
 bitdata PWR_CR3 :: Bits 32 = pwr_cr3
  { _                  :: Bits 16  -- (Reserved)
  , pwr_cr3_eiwul        :: Bit      -- Enable external WakeUp line
  , pwr_cr3_ucpd1_dbdis  :: Bit      -- DBDIS
  , pwr_cr3_ucpd1_stdby  :: Bit      -- STDBY
  , _                  :: Bits 2   -- (Reserved)
...
--  | address: 0x40007080
[ivory|
 bitdata PWR_CR5 :: Bits 32 = pwr_cr5
  { _             :: Bits 31  -- (Reserved)
  , pwr_cr5_r1mode  :: Bit      -- Main regular range 1 mode
  }
|]
pwr_reg_cr5 :: BitDataReg PWR_CR5
pwr_reg_cr5 = mkBitDataRegNamed (pwr_periph_base + 0x80) "cr5"
