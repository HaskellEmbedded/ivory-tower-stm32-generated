...
module Ivory.BSP.STM32F779.FLASH where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F779.MemoryMap (flash_periph_base)
...
[ivory|
 bitdata FLASH_CR :: Bits 32 = flash_cr
  ...
  , flash_cr_mer2   :: Bit      -- Mass Erase of sectors 12 to 23
  , _             :: Bits 5   -- (Reserved)
  , flash_cr_psize  :: Bits 2   -- Program size
  , flash_cr_snb    :: Bits 5   -- Sector number
  , flash_cr_mer1   :: Bit      -- Mass Erase of sectors 0 to 11
...
[ivory|
 bitdata FLASH_OPTCR :: Bits 32 = flash_optcr
  ...
  , flash_optcr_ndbank      :: Bit      -- Not dual bank mode
  , flash_optcr_ndboot      :: Bit      -- Dual Boot mode (valid only when nDBANK=0)
