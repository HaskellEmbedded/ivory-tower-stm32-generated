...
module Ivory.BSP.STM32F407.RCC where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F407.MemoryMap (rcc_periph_base)
...
[ivory|
 bitdata RCC_AHB3LPENR :: Bits 32 = rcc_ahb3lpenr
  { _                     :: Bits 31  -- (Reserved)
  , rcc_ahb3lpenr_fsmclpen  :: Bit      -- Flexible static memory controller module clock enable during Sleep mode
  }
|]
