...
module Ivory.BSP.STM32F469.FLASH where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F469.MemoryMap (flash_periph_base)
...
[ivory|
 bitdata FLASH_SR :: Bits 32 = flash_sr
  ...
  , _              :: Bits 7   -- (Reserved)
  , flash_sr_rderr   :: Bit      -- Proprietary readout protection (PCROP) error
...
[ivory|
 bitdata FLASH_CR :: Bits 32 = flash_cr
  ...
  , flash_cr_mer1   :: Bit      -- Mass Erase of sectors 12 to 23
  , _             :: Bits 5   -- (Reserved)
  , flash_cr_psize  :: Bits 2   -- Program size
  , flash_cr_snb    :: Bits 5   -- Sector number
...
[ivory|
 bitdata FLASH_OPTCR :: Bits 32 = flash_optcr
  { flash_optcr_sprmod      :: Bit      -- Selection of protection mode for nWPRi bits
  , flash_optcr_db1m        :: Bit      -- Dual-bank on 1 Mbyte Flash memory devices
  , _                     :: Bits 2   -- (Reserved)
  ...
  , flash_optcr_bfb2        :: Bit      -- Dual-bank Boot option byte
...
[ivory|
 bitdata FLASH_OPTCR1 :: Bits 32 = flash_optcr1
  { _                :: Bits 4   -- (Reserved)
  , flash_optcr1_nwrp  :: Bits 12  -- Not write protect
  , _                :: Bits 16  -- (Reserved)
  }
|]
