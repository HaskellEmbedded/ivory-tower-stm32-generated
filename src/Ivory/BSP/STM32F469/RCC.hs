...
module Ivory.BSP.STM32F469.RCC where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F469.MemoryMap (rcc_periph_base)
...
[ivory|
 bitdata RCC_PLLCFGR :: Bits 32 = rcc_pllcfgr
  { _                  :: Bit      -- (Reserved)
  , rcc_pllcfgr_pllr   :: Bits 3   -- Main PLL division factor for DSI clock
...
[ivory|
 bitdata RCC_AHB1RSTR :: Bits 32 = rcc_ahb1rstr
  ...
  , _                      :: Bits 3 -- (Reserved)
  , rcc_ahb1rstr_ethmacrst :: Bit    -- Ethernet MAC reset
  , _                      :: Bit    -- (Reserved)
  ...
  , _                      :: Bit    -- (Reserved)
  , rcc_ahb1rstr_gpiokrst  :: Bit    -- IO port K reset
  , rcc_ahb1rstr_gpiojrst  :: Bit    -- IO port J reset
...
[ivory|
 bitdata RCC_AHB2RSTR :: Bits 32 = rcc_ahb2rstr
  ...
  , rcc_ahb2rstr_hsahrst  :: Bit     -- Hash module reset
  , rcc_ahb2rstr_cryprst  :: Bit     -- Cryptographic module reset
  , _                     :: Bits 3  -- (Reserved)
...
[ivory|
 bitdata RCC_AHB3RSTR :: Bits 32 = rcc_ahb3rstr
  { _                    :: Bits 30 -- (Reserved)
  , rcc_ahb3rstr_qspirst :: Bit     -- QUADSPI memory controller reset
...
[ivory|
 bitdata RCC_APB2RSTR :: Bits 32 = rcc_apb2rstr
  { _                      :: Bits 4 -- (Reserved)
  , rcc_apb2rstr_dsirst    :: Bit    -- DSI host reset
  , rcc_apb2rstr_ltdcrst   :: Bit    -- LTDC reset
  , _                      :: Bits 3 -- (Reserved)
  , rcc_apb2rstr_sai1rst   :: Bit    -- SAI1 reset
  , rcc_apb2rstr_spi6rst   :: Bit    -- SPI6 reset
...
[ivory|
 bitdata RCC_APB2ENR :: Bits 32 = rcc_apb2enr
  { _                    :: Bits 4 -- (Reserved)
  , rcc_apb2enr_dsien    :: Bit    -- DSI clocks enable
...
[ivory|
 bitdata RCC_APB2LPENR :: Bits 32 = rcc_apb2lpenr
  { _                        :: Bits 4 -- (Reserved)
  , rcc_apb2lpenr_dsilpen    :: Bit    -- DSI clocks enable during Sleep mode
  , rcc_apb2lpenr_ltdclpen   :: Bit    -- LTDC clock enable
  , _                        :: Bits 3 -- (Reserved)
  , rcc_apb2lpenr_sai1lpen   :: Bit    -- SAI1 clock enable
  , rcc_apb2lpenr_spi6lpen   :: Bit    -- SPI 6 clock enable during Sleep mode
...
[ivory|
 bitdata RCC_PLLSAICFGR :: Bits 32 = rcc_pllsaicfgr
  { _                      :: Bit    -- (Reserved)
  , rcc_pllsaicfgr_pllsair :: Bits 3 -- PLLSAI division factor for LCD clock
  , rcc_pllsaicfgr_pllsaiq :: Bits 4 -- PLLSAI division factor for SAI1 clock
  , _                      :: Bits 6 -- (Reserved)
...
[ivory|
 bitdata RCC_DCKCFGR :: Bits 32 = rcc_dckcfgr
  { _                      :: Bits 2 -- (Reserved)
  , rcc_dckcfgr_dsisel     :: Bit    -- DSI clock source selection
  , rcc_dckcfgr_sdiosel    :: Bit    -- SDIO clock source selection
  , rcc_dckcfgr_ck48msel   :: Bit    -- 48 MHz clock source selection
  , _                      :: Bits 2 -- (Reserved)
  , rcc_dckcfgr_timpre     :: Bit    -- Timers clocks prescalers selection
  , rcc_dckcfgr_sai1bsrc   :: Bits 2 -- SAI1-B clock source selection
  , rcc_dckcfgr_sai1asrc   :: Bits 2 -- SAI1 clock source selection
  , _                      :: Bits 2 -- (Reserved)
  , rcc_dckcfgr_pllsaidivr :: Bits 2 -- PLLSAIDIVR
  , _                      :: Bits 3 -- (Reserved)
