...
module Ivory.BSP.STM32L4Plus.FLASH where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32L4Plus.MemoryMap (flash_periph_base)
...
[ivory|
 bitdata FLASH_WRP1AR :: Bits 32 = flash_wrp1ar
  ...
  , _                      :: Bits 8   -- (Reserved)
  , flash_wrp1ar_wrp1a_strt  :: Bits 8   -- Bank 1 WRP first area start offset
  }
|]
