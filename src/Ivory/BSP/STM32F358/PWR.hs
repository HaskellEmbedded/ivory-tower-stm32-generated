...
module Ivory.BSP.STM32F358.PWR where

import Ivory.Language
import Ivory.HW
import Ivory.BSP.STM32F358.MemoryMap (pwr_periph_base)
...
[ivory|
 bitdata PWR_CR :: Bits 32 = pwr_cr
  { _           :: Bits 20  -- (Reserved)
  , pwr_cr_ensd3  :: Bit      -- ENable SD3 ADC
  , pwr_cr_ensd2  :: Bit      -- ENable SD2 ADC
  , pwr_cr_ensd1  :: Bit      -- ENable SD1 ADC
